...
function CreateFullBill4() {
    ...
    LODOP.SET_PRINT_STYLEA(0, "FontColor", "#000000");
    LODOP.ADD_PRINT_TEXT(83, -9, 169, 20, "票号:" + code);
    $("#code_sn").val(code);
...
function  shopcode() {
    ...
    if ((mySecondes + "").length < 2) {
        mySecondes = 0 + "" + mySecondes;
    }
    var times = myYear + "" + myMonth + "" + myDay + "" + myHours + "" + myMinutes + "" + mySecondes;
    return times;
}
